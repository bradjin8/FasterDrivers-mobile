    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='driver/images')),
                ...
                ('car_vin', models.CharField(blank=True, max_length=255)),
                ('car_license_number', models.CharField(blank=True, max_length=255)),
