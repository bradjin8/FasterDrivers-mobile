"""
Django settings for fancy_cherry_36842 project.
...
WSGI_APPLICATION = 'fancy_cherry_36842.wsgi.application'
...
CONNECTED_SECRET = env.str("CONNECTED_SECRET", "whsec_Rkreg1u8SZhJIEz9kgCZu7UeQf25r2u3")
STRIPE_TEST_SECRET_KEY = env.str("STRIPE_TEST_SECRET_KEY", "sk_test_51N0lDHHuKvl8e8x1a74QqtPFte1Mmpm89LsaWUKU0jjryJqIahrNIeRIeevsxGNIju6gyS3MuF6RKfKAwIFwD64K00xBBY1EQf")
STRIPE_LIVE_SECRET_KEY = os.environ.get("STRIPE_LIVE_SECRET_KEY", "")
STRIPE_LIVE_MODE = env.bool("STRIPE_LIVE_MODE", False)
DJSTRIPE_WEBHOOK_SECRET = env.str("DJSTRIPE_WEBHOOK_SECRET", "whsec_3ZxYlEdBzADfEpeKYNlyRUX6d9Qqea0S")
