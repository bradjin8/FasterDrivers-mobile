...
export default function AssignToDriver({onClose}) {
  ...
  return (
    <Flex direction={'column'} gap={4}>
      <Flex gap={2} alignItems={'center'}>
        <IoArrowBackCircle onClick={onClose} size={30}/>
        <Text>Map</Text>
      </Flex>
      <Flex h={'80vh'} w={'100%'} position={'relative'}>
        ...
        >
          ...
          <Flex justifyContent={'center'}>
            <Button colorScheme={'primary'} borderRadius={20} isLoading={loading} onClick={assign}>Assign</Button>
          </Flex>
        </Flex>}
      </Flex>
    </Flex>
